...
//
//
//class old_W_work : AppCompatActivity() {
...
//
//            // DB 입력
////            editOrderEnd(order_id, start_time, end_time, pause_time, "종료")
//
...
//    }
//
//    private fun editOrderEnd(order_id: String, working_time: String, pause_time: String, total_time:String, status: String){
//
//        // 생산오더에 emp_id, emp_name을 입력하고, status를 '릴리스됨'에서 '시작됨'으로 변경
//        val retrofit = Retrofit.Builder()
//            .baseUrl("http://192.168.1.197:80/")
...
//        val prodservice: S_production = retrofit.create(S_production::class.java)
//
////        prodservice.updateProdInfo(order_id, start_time, end_time, pause_time, status).enqueue(object : Callback<D_msg> { //받는 값이 List 형식이면 Callback<List<D_production>>
////            override fun onFailure(call: Call<D_msg>, t: Throwable) {
////                val dialog = AlertDialog.Builder(this@W_work)
////                dialog.setTitle("에러")
////                dialog.setMessage(t.message)
